...
const DeletePostModal = ({ open, handleClose, isLoading, handleDeletePost }) => {
            ...
            <Box sx={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: {xs: "260px", sm: "460px", height: "140px", backgroundColor: theme.palette.background.default, border: "none" }}}>
                <Box sx={{ p: 3}}>
                    ...
                    <Stack flexDirection={"row"} mt={3} alignItems={"center"} gap={3} justifyContent={"flex-end"}>
                        <Button onClick={handleDeletePost} disabled={isLoading} variant="contained" sx={{ backgroundColor: "#f44336", color: "#ffffff", "&:hover": { backgroundColor: "#d32f2f"}, fontSize: {xs: "13px", sm: "15px"}, width: "80px", height: "37px", "&.Mui-disabled": {
